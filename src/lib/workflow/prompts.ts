...
export const defaultPromptVersionSuffix = "v8";
...
- This workflow prepares inputs for AI image/video generation, not live-action filming, stock-footage editing, or creator collaboration.
- Never propose real-world shooting logistics, hiring actors, finding footage, two-person filming, handheld phone capture, post-production shortcuts, or "if real material is hard to find" workarounds.
- Treat all people, animals, objects, locations, camera language, lighting, and movement as generated on-screen content controlled by prompts.
...
This is the first visible decision step for an AI-generated short video. Give the user a small set of clear concept options that can be generated by image/video models. Do not develop detailed story structure, key visuals, visual direction, or generation constraints yet.
...
- Keep each option self-contained: what AI-generated on-screen content appears and why it works.
...
- Mention real filming, creators, actors, footage, camera operators, editing existing material, split-screen collaboration, or any method that depends on non-generated assets.
  ...
  "concept_variations": [
    {
      ...
      "description": "what generated on-screen content happens in this version",
...
Turn the approved concept into section-level script blocks for an AI-generated video. The script must be natural to hear and structured enough for generated visual planning.
...
- Make visual_intent describe what generated visuals must accomplish, while leaving exact virtual shot planning for the next stage.
...
Split the approved script into concrete virtual shots for AI video generation. Shots are planning units only; Scene Blocks for video generation come later.

Do:
- Cover every script section in order, using one or more shots per section.
- Use realistic generated-clip durations and keep each shot's visible action simple enough for a video model to generate.
- Describe generated subject, environment, props, virtual camera distance, angle, lens/framing feel, and motion.
...
- Mention filming logistics, real actors, captured footage, phone shooting, or editing existing videos.
  ...
  "shots": [
    {
      ...
      "camera": "virtual shot size, angle, framing, and lens feel",
      "motion": "generated subject movement and/or virtual camera movement",
...
- Mention real filming, editing existing footage, or production logistics.
...
export function createDefaultPromptVersions(): PromptVersion[] {
  return promptNodes.map((node) => ({
    ...
    changeNote: "Creative-plan V8 AI-generation-only contract",
    createdAt: nowIso(),
    createdBy: "system",
  }));
}
